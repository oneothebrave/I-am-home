...
export const styles = StyleSheet.create({
  ...
  diagnosticSummaryCardAttention: {
    backgroundColor: '#F7E9D7',
    borderColor: '#E8CDA7',
  },
  diagnosticSummaryCardNeutral: {
    backgroundColor: '#F1ECE4',
    borderColor: '#DED5C8',
  },
  ...
  diagnosticSummaryTitleAttention: {
    color: '#8A5A20',
  },
  diagnosticSummaryTitleNeutral: {
    color: '#5E584D',
  },
  diagnosticSummaryEyebrow: {
    color: '#235D4C',
    fontSize: 14,
    fontWeight: '800',
    marginTop: 13,
  ...
  diagnosticTimelineRail: {
    alignItems: 'center',
    marginHorizontal: 10,
    position: 'relative',
    width: 14,
  },
  diagnosticTimelineDot: {
  ...
  diagnosticTimelineDotRisk: {
    backgroundColor: '#C46A43',
  },
  diagnosticTimelineDotRecovery: {
    backgroundColor: '#2F7B62',
  },
  diagnosticTimelineDotNotification: {
    backgroundColor: '#B18436',
  },
  diagnosticTimelineLine: {
  ...
  diagnosticTimelineDetail: {
    color: '#686157',
    fontSize: 14,
    lineHeight: 21,
    marginTop: 4,
  },
  diagnosticFutureCard: {
  ...
  diagnosticFutureTitle: {
    color: '#343029',
    fontSize: 16,
    fontWeight: '800',
  },
  diagnosticFutureTime: {
    color: '#4F675E',
    fontSize: 15,
    fontVariant: ['tabular-nums'],
    lineHeight: 22,
